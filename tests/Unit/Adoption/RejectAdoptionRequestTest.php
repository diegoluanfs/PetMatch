...
final class RejectAdoptionRequestTest extends TestCase
{
    ...
    public function test_rejects_pending_request_for_own_pet(): void
    {
        ...
        $useCase = new RejectAdoptionRequest(
            $petRepository,
            $requestRepository,
            $userRepository,
            $sessionManager,
        ...
        self::assertSame('available', $petRepository->findById($petId)->status);
    }
